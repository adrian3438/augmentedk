...
export default function ContentsListPage ({
  contentsType , businessType , page , size , keyword , column , order
    ...
    async function getList () {
        try{
            const response = await api.get(`/admin/contents/getContentsList.php?promLang=KR&contentsType=${contentsType}&businessDivisionType=${0}&page=${page}&size=${size}&keyword=${keyword}&sortColumn=promDate&sortOrder=${order}`)
